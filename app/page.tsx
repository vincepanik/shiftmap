      ...
      <nav id="main-nav">
        <div className="nav-inner">
          ...
          <ul className="nav-links">
            ...
            <li><a href="https://buy.stripe.com/eVq00k3HeaH536qcsXeOB35" className="nav-cta">Démarrer maintenant</a></li>
          </ul>
          <button
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <div className="hero-actions">
              <a href="https://buy.stripe.com/eVq00k3HeaH536qcsXeOB35" className="btn btn-primary">
                Démarrer maintenant
        ...
        <div className="container">
          ...
          <div className="pricing-grid">
            ...
            <div className="pricing-card fade-up">
              ...
              <a href="https://buy.stripe.com/eVq00k3HeaH536qcsXeOB35" className="pricing-cta">
            ...
            <div className="pricing-card featured fade-up">
              ...
              <a href="https://buy.stripe.com/eVq7sM3He8yX6iC8cHeOB36" className="pricing-cta">
                Commencer avec Pro →
              </a>
            </div>
            ...
            <div className="pricing-card fade-up">
              ...
              <a href="https://buy.stripe.com/6oUdRa6Tq9D14au50veOB37" className="pricing-cta">
        ...
        <div className="container">
          <div className="cta-final-content">
            ...
            <div className="cta-final-actions">
              <a href="https://buy.stripe.com/eVq00k3HeaH536qcsXeOB35" className="btn btn-primary" style={{fontSize:'16px',padding:'16px 32px'}}>
